...
describe("Strip ", () => {
  ...
  it("can set a background", () => {
    const wrapper = shallow(<Strip background="test.png">content</Strip>);
  ...
  it("can add additional classes", () => {
    const wrapper = shallow(<Strip className="extra-class">content</Strip>);
